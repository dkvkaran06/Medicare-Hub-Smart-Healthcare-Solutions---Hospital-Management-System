  ...
  useEffect(() => {
    const loadStats = async () => {
      ...
      setStats({
        ...
        pendingBills: billsRes.data.filter((b) => b.paymentStatus === 'PENDING').length,
      });
    };

    loadStats().catch(() => {
      setStats({ patients: 0, doctors: 0, appointments: 0, pendingBills: 0 });
    });
  }, []);
    ...
    <div className="page-content">
      ...
      <div className="welcome-banner">
        ...
        <p>
          ...
          {user?.role === 'doctor' && ' You can view your daily schedule, Reach Patients Appointment at home!'}
          {user?.role === 'admin' && ' Manage your hospital operations from this dashboard.'}
          {user?.role === 'patient' && ' Find your doctor and book appointments easily!'}
        </p>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-section">
          <h4>Upcoming Appointments until Next Friday</h4>
